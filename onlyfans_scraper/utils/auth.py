...
def create_sign(link, headers):
    ...
    checksum = sum([sha_1_b[31], sha_1_b[13], sha_1_b[8], sha_1_b[3], sha_1_b[25], sha_1_b[8], sha_1_b[33], sha_1_b[25], sha_1_b[1], sha_1_b[23], sha_1_b[37], sha_1_b[11], sha_1_b[2], sha_1_b[29], sha_1_b[9], sha_1_b[7],
                    sha_1_b[29], sha_1_b[30], sha_1_b[18], sha_1_b[25], sha_1_b[18], sha_1_b[21], sha_1_b[10], sha_1_b[37], sha_1_b[28], sha_1_b[35], sha_1_b[31], sha_1_b[5], sha_1_b[13], sha_1_b[31], sha_1_b[2], sha_1_b[9]]) + 1110

    final_sign = "6:{}:{:x}:609184ae".format(sha_1_sign, abs(checksum))
